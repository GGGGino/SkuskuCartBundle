...
class CurrencyCreateCommand extends ContainerAwareCommand
{
    ...
    protected function interact(InputInterface $input, OutputInterface $output)
    {
        ...
        $abstractEntities = $this->getAbstractEntities();
     ...
     * @return array
     */
    private function getAbstractEntities()
    {
        /** @var SkuskuHelper $skuskuHelper */
        $skuskuHelper = $this->getContainer()->get(SkuskuHelper::class);

        /** @var array $abstractEntities */
        return $skuskuHelper->getAbstractEntities();
    }
}